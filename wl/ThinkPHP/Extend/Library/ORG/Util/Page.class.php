...
class Page {
    ...
    public function show2() {
    	//$this->config  =    array('prev'=>'<<','next'=>'>>','first'=>'第一页','last'=>'最后一页','theme'=>'  %nowPage%/%totalPage% 页 %upPage% %downPage% %first%  %prePage%  %linkPage%  %nextPage% %end%');
...
//             array($this->nowPage,$this->totalRows,$this->totalPages,$upPage,$downPage,$theFirst,$prePage,$linkPage,$nextPage,$theEnd),$this->config['theme']);
//         return $pageStr;
    }
